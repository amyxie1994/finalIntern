...
<div id="myModal2" class="modal">
      ...
      <form action="php/productOperations.php" method="post"  enctype="multipart/form-data">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><b>Update Product Information</b></h4>
          
        </div>
        <div class="modal-body">
        <input type="hidden"  id = "EditProductId" name ="EditProductId"> 
     <input type="hidden" value = "editProduct" id = "type" name ="type">
<td> <input type="hidden"  id = "editsupplierId" name ="editsupplierId"> </td>
<table style="width:100%">
    <tr>
        <td><b> Name: </b></td>
        <td> <input type="text"   id = "productName22" name ="productName22"> </td>
        <td><b>Item No:</b></td>
        <td><input type="text"   id = "Model22" name ="Model22"></td>
        <td> <input type="hidden"  id = "supplierID22" name ="supplierID22"> </td>
    </tr>

    <tr>
        <td><b>Main Key Word</b></td>
        <td> <input type="text"   id = "mainKW22" name ="mainKW22"> </td>
        <td> <b>Other Keyword </b></td>
        <td><input type="text"   id = "otherKW22" name ="otherKW22"></td>
    </tr>
    <tr>
       <td><b> Material:</b></td>
       <td> <input type="text"   id = "Craft22" name ="Craft22"> </td>
       <td><b> Thickness</b></td>
      <td><input type="text"   id = "PLt22" name ="PLt22"></td>
    ...
    <td><b> Size: </b></td>
      ...
      <td><b>Carton Size:(CM)</b></td>
        <td><input type="text"   id = "Csize22" name ="Csize22"></td>
    ...
    <td><b>Port:</b></td>
        <td><input type="text"   id = "STime22" name ="STime22"></td>
   </tr>
   <tr> 
      <td> <b>CBM/CTN:</b></td>
       <td> <input type="text" id = "PSize22" name ="PSize22"></td>
      <td><b>PCs/CTN</b> </td>
        <td><input type="text"   id = "Packing22" name ="Packing22"></td>  
    </tr> 
    
    
    <tr> 
      <td><b>QTY</b></td>
        <td><input type="text"   id = "QTY22" name ="QTY22"></td>
        
    </tr>
    <tr> 
      <td><b> Other Info </b></td>
        <td><textarea rows="4" cols="50"   id = "OtherInfo22" name ="OtherInfo22"></textarea></td>
